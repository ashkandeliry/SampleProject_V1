...
{
    public class AppException : ITException
    {
        ...
        public AppException(ApiResultStatusCode statusCode, HttpStatusCode httpStatusCode, object additionalData)
            : this(statusCode, null,httpStatusCode, additionalData)
        {
        }
        ...
        public AppException(string message, Exception exception, HttpStatusCode httpStatusCode, object additionalData)
            : this(ApiResultStatusCode.ServerError, message,httpStatusCode, exception,additionalData)
        {
        }
